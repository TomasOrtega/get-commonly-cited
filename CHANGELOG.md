...
- typed Python API, tests, documentation, CI, release automation, and community files

[Unreleased]: https://github.com/TomasOrtega/get-commonly-cited/compare/v0.1.0...HEAD
